...
const BoxPlotStability = ({ groupedData }: { groupedData: Record<string, number[]> }) => {
  ...
  useEffect(() => {
    ...
    const option: ChartOption = {
      title: {
        text: 'Binding Stability by Antigen Source', // Chart title
      ...
      yAxis: {
        type: 'value',
        name: 'Binding Stability', // Label for y-axis
      },
      toolbox: {
...
export default BoxPlotStability; // Export the component as default
